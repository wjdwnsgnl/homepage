...
<?
	...
	$scale=10;     //한화면에 표시되는 글의 개수

	if($mode=="search"){
		if(!$search){
			echo ("
				<script>
					alert('검새할 단어를 입력해 주세요!');
					history.go(-1);
				</script>
				");
			exit;
 	...
 	<div id="wrap">
 		...
 		<div id="content">
			...
			<section id="col2">
				...
				<form action="list.php?table=<?=$table?>&mode=cearch" method="post" name="board_form">
					<div id="list_search">
